            ...
            <FadeInWhenVisible>
              <div className="space-y-4 max-w-4xl">
                ...
                <p className="text-gray-600">
                  ...
                  passion. High-performance, precision-engineered, just a click
                  away.
                  <br />
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-center">
                    ...
                    <span>Industrial-Grade Machinery and Precision Tools</span>
                  </li>
                  <li className="flex items-center">
                  ...
                  <li className="flex items-center">
                    ...
                    <span>Heavy-Duty Construction Equipment and Machinery</span>
                  </li>
                </ul>
                <Button
                  size="lg"
